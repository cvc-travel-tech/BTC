...
$(function() {
                 ...
                 $(".panel-footer .heading-elements-toggle").on(
                     "click",
                     function() {
                         $(this)
                             .parent()
                 ...
                 $('.dropdown-content a[data-toggle="tab"]').on(
                     "click",
                     function(e) {
                         $(this).tab("show");
                     }
                 ...
                 $(
                     ".sidebar-default .category-title [data-action=reload]"
                 ).click(function(e) {
                     e.preventDefault();
                     var block = $(this)
                         .parent()
                 ...
                 $(document).on("click", ".navigation .disabled a", function(
                     e
                 ) {
                     e.preventDefault();
                 });
                 ...
                 $(document).on("click", ".sidebar-opposite-toggle", function(
                     e
                 ) {
                     e.preventDefault();
                         ...
                         setTimeout(function() {
                             ...
                             if ($(window).width() <= 768) {
                                 ...
                                 // Revert right detached position
                                     ...
                                     $("body").hasClass("has-detached-right")
                                 ) {
